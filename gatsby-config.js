...
module.exports = {
  siteMetadata: {
    title: `Pattex Distillery`,
    description: `Pattex Distillery`,
    author: `@kingsdesign`,
  },
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `pattex-distillery`,
        short_name: `pattex-distillery`,
        start_url: `/`,
    ...
    },
    {
      ...
      options: {
        ...
        paginationSize: 50, //We can set this pretty low as we're expecting only a handful of products
